      ...
      <div className="absolute top-[10%] md:top-[15%] lg:top-[10%] left-0 w-full lg:h-[600px] flex flex-col md:flex-row lg:flex-row justify-evenly items-center p-5">
       <Slide direction="left">
        <div className='w-full md:w-[400px] lg:w-[600px] '>
          <h1 className='text-3xl md:text-4xl lg:text-7xl text-gray-800'>Our System <br /> <span className='text-black font-bold'>Will  <Typewriter
            words={['Grow', 'Improve', 'Enhance', 'Revolutionize!']}
            loop={true}
            cursor
            cursorStyle='_'
            typeSpeed={70}
          ...
          /></span><br /> <span className='text-blue-600 font-bold'>Your User Experience</span></h1><br />
